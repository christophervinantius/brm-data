    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body bg-dark">
          <div class="mb-3">
            <button class="btn btn-success me-2" @click="exportPresetsToExcel" :disabled="selectedPresetIds.length === 0">
              Export to Excel
            </button>
            <button class="btn btn-outline-success me-2" @click="showImportExcel = true">
              Import from Excel
            </button>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <h6 class="card-title text-white">
                        <input type="checkbox" :checked="isPresetSelected(preset.id)" @change.stop="toggleSelectPreset(preset.id)" @click.stop style="margin-right:6px;vertical-align:middle">
                        {{ preset.name }}
                        <small class="ms-2">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <small class="text-white">Race Information</small>
                        ...
                        <div class="col-sm-6">
                          <small class="text-white">Strategy Plans ({{ preset.savedPlans.length }})</small>
          ...
          <div v-if="presets.length === 0" class="text-center py-5 bg-dark">
            <h5 class="text-white">No presets yet</h5>
          </div>

          <div v-else-if="filteredPresets.length === 0" class="text-center py-3 bg-dark">
            <h6 class="text-white">No presets found</h6>
          </div>
        </div>
...
const emit = defineEmits(['close', 'load', 'delete', 'import-preset'])
